...
const ActiveLoanScreen = ({ userName = 'UserName', navigation }:any) => {
  ...
  const renderLoanCard = ({ item }:any) => (
    ...
    >
      <View
        style={[styles.innerCard, { backgroundColor: isDarkMode ? '#292929' : '#f7f7f7f8' }]}
      >
  ...
  return (
    <View
      style={[styles.container, { backgroundColor: isDarkMode ?  '#292929':Colors.lightBackground }]}
    > 
      
      {/* Top Section */}
      <View
        style={[styles.topSection, { backgroundColor: isDarkMode ? Colors.black:Colors.white }]}
      >
